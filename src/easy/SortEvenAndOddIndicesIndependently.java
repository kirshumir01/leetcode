...
public class SortEvenAndOddIndicesIndependently {
    ...
    public static void main(String[] args) {
        ...
        // must be: [1, 4, 8, 2]
        System.out.println("Array after sorting #1: " + Arrays.toString(solution1.sortEvenOdd(n)));
        System.out.println("Array after sorting #2: " + Arrays.toString(solution2.sortEvenOdd(n)));
    }
}